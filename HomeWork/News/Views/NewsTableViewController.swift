...
//            self.newsPost.getNewsArray(countNews: 10)
    ...
    @objc private func onRefreshTriggered() {
        ...
        //newsPost.getNewsArray(countNews: 10, startTime: mostFreshNewsDate)
...
//            if let arrAttachments = newsArray[indexPath.section].attachments {
